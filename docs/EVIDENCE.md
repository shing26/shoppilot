...
| 221 条 JVM 测试与 Linux 干净 runner | ticket 32、README badge | `.github/workflows/ci-subset.yml`、GitHub Actions run | 本地 `.\mvnw.cmd -B -ntp verify`；CI `bash ./mvnw -B -ntp verify` | CI 不覆盖 17 步活体验收、Docker、Ollama、评测或压测 |
