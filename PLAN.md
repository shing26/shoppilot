...
| 9/11 追加（ticket 20） | S7 之后的判据收口 | 重标 4 条 gold 的合格答案集 + 修评分器三处缺陷，零模型额度、零阈值改动 |
...
| 20 | 对 09-10 那 6 份 dev 明细跑 `--rescore` | 新旧 `tool_ok` 的差异集合恰好等于放开的那 4 条 id，其余 176 条逐格一致；本票 24 条验收逐条留证据 |
